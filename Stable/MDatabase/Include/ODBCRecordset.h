...
#define BINARY_FIELD_MAX_SIZE	7000	// DB�� ����� Binary�ʵ��� �ִ� ũ��(�ִ�ũ��� 8000).
#define BINARY_CHUNK_SIZE		7000	// Binary�ʵ忡 �����͸� �����Ҷ� BINARY_CHUNK_SIZE���� ũ�� ������ ����.
#define RESERVE_SIZE			100		// CDBBinaryŬ���� vector�ڷᱸ���� ���ؼ� ���.
...
public:
	...
	int SetData(const unsigned char* pData, const int nInDataSize)
	{
		if ((0 == pData) ||
			...
			(0 > nInDataSize)) // 0 > nInDataSize �̰��� NULL�� �о����� ũ�⸦ 0���� ������ �ֱ� ���ؼ�.
			return -1;
...
private:
	int				m_iIndex;				// Insert, Get�� ���� ������ ������index.
	int				m_iCurrentUsedSize;		// InsertData( )�� ���ؼ� �߰��� �� �ʵ� ��.
	int				m_ReserveSize;
